...
\begin{document}
  ...
  aliphatic chains, remaining close to the interface at equilibrium. \\
	...
	cell membrane behavior, Benzocaine ($\log P_{\nicefrac{O}{W}} = 2.12$\todo{ G.R. Strichartz, V. Sanchez, R. Arthur, R. Chafetz, D. Martin,Anesth.  Analg.  71  (1990)  158.}) and Levodopa ($\log P_{\nicefrac{O}{W}} = -2.39$\todo{Sangster, J., 1993. “Log Kow Databank”, Sangster Res. Lab.Montreal, Quebec, Canada.}) were dissolved in the mesophase
